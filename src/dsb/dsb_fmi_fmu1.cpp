...
dsb::fmi::FMIVersion FMU1::FMIVersion() const
{
    return dsb::fmi::FMIVersion::v1_0;
}


const dsb::model::SlaveTypeDescription& FMU1::Description() const
{
...
std::shared_ptr<dsb::fmi::Importer> FMU1::Importer() const
{
    return m_importer;
}
...
SlaveInstance1::~SlaveInstance1() DSB_NOEXCEPT
{
    if (m_initialized) {
...
const dsb::model::SlaveTypeDescription& SlaveInstance1::TypeDescription() const
{
...
double SlaveInstance1::GetRealVariable(dsb::model::VariableID varID) const
{
...
int SlaveInstance1::GetIntegerVariable(dsb::model::VariableID varID) const
{
    const auto valRef = m_fmu->FMIValueReference(varID);
...
bool SlaveInstance1::GetBooleanVariable(dsb::model::VariableID varID) const
{
    const auto valRef = m_fmu->FMIValueReference(varID);
...
std::string SlaveInstance1::GetStringVariable(dsb::model::VariableID varID) const
{
    const auto valRef = m_fmu->FMIValueReference(varID);
...
void SlaveInstance1::SetRealVariable(dsb::model::VariableID varID, double value)
{
    const auto valRef = m_fmu->FMIValueReference(varID);
...
void SlaveInstance1::SetIntegerVariable(dsb::model::VariableID varID, int value)
{
    const auto valRef = m_fmu->FMIValueReference(varID);
...
void SlaveInstance1::SetBooleanVariable(dsb::model::VariableID varID, bool value)
{
...
void SlaveInstance1::SetStringVariable(dsb::model::VariableID varID, const std::string& value)
{
...
std::shared_ptr<dsb::fmi::FMU> SlaveInstance1::FMU() const
{
    return FMU1();
}


std::shared_ptr<dsb::fmi::FMU1> SlaveInstance1::FMU1() const
{
    return m_fmu;
}
