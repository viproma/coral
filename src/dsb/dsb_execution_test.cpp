...
TEST(dsb_execution, Controller)
{
    ...
    EXPECT_THROW(exec.SetVariables(4, dsb::sequence::EmptySequence<dsb::types::Variable>()), std::logic_error);
    ...
    EXPECT_THROW(exec.ConnectVariables(4, dsb::sequence::EmptySequence<dsb::types::VariableConnection>()), std::logic_error);
