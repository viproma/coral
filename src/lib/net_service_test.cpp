...
TEST(coral_net_service, Listener)
{
    ...
    auto beacon1 = coral::net::service::Beacon(
        100,
        "serviceType1",
        "service1",
        "foo", 3,
        ...
        "*",
        port);
    auto beacon2 = coral::net::service::Beacon(
        100,
        "serviceType2",
        "service2",
        nullptr, 0,
        ...
        "127.0.0.1",
        port);
    auto beacon3 = coral::net::service::Beacon(
        101,
        "serviceType1",
        "service3",
        "baz", 3,
    ...
    auto listener = coral::net::service::Listener{
        reactor,
        100,
    ...
    reactor.AddTimer(
        ...
        1,
        [] (coral::net::Reactor& r, int) { r.Stop(); });
    reactor.Run();
...
TEST(coral_net_service, Tracker)
{
    namespace sc = std::chrono;

    const int partitionID = 0;
    const std::uint16_t port = 63948;
    std::unique_ptr<coral::net::service::Beacon> beacon11, beacon12, beacon21, beacon31;
    ...
    reactor.AddTimer(
        ...
        [&] (coral::net::Reactor&, int) {
            beacon11 = std::make_unique<coral::net::service::Beacon>(
                partitionID,
                "serviceType1",
                "service1.1",
    ...
    reactor.AddTimer(
        ...
        [&] (coral::net::Reactor&, int) {
            beacon12 = std::make_unique<coral::net::service::Beacon>(
                partitionID,
                "serviceType1",
                "service1.2",
    ...
    reactor.AddTimer(
        ...
        [&] (coral::net::Reactor&, int) {
            beacon21 = std::make_unique<coral::net::service::Beacon>(
                partitionID,
                "serviceType2",
                "service2.1",
    ...
    reactor.AddTimer(
        ...
        [&] (coral::net::Reactor&, int) {
            beacon31 = std::make_unique<coral::net::service::Beacon>(
                partitionID,
                "serviceType3",
                "service3.1",
    ...
    reactor.AddTimer(
        testStopTime, 1,
        [&] (coral::net::Reactor&, int) { reactor.Stop(); });
    ...
    auto tracker = coral::net::service::Tracker{
        reactor,
        0,
        coral::net::ip::Endpoint{"*", port}};
